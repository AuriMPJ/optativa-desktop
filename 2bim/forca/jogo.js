...
const palavras = {
  ...
  medio: [{
    palavra: 'empatia',
    dica: 'Esse professor tem bastante...'
  },
  {
    palavra: 'exceção',
    dica: 'Código mal feito gera uma...'
  },
...
dificil: [{
  palavra: 'essencial',
  dica: 'Aprender é ... na vida de um estudante'
},
{
  palavra: 'confiança',
  dica: 'Um bom relacionamento é feito com...'
},
...
function cadastrarPalavra() {
  ...
  palavras[dificuldadeSelecionada].push(palavraDica)
